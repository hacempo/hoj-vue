...
//
import HomeView from "@/views/oj/chat/HomeView.vue";
import webssh from "@/views/oj/chat/webssh.vue";
import grapheditor from "@/views/oj/chat/grapheditor.vue";
...
const ojRoutes = [
  ...
  },
  {
    ...
    meta: { title: "HomeView" },
    component: HomeView,
    // meta: { requireAuth: true,title: 'HomeView' }
  },
  {
    path: "/webssh",
    meta: { title: "webssh" },
