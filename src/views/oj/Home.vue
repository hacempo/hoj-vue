    ...
    <el-row :gutter="20">
      ...
      <el-col :md="9" :sm="24" class="phone-margin">
        ...
        <el-card class="card-top">
          <div slot="header" class="clearfix title">
            <span class="home-title panel-title">
              <i class="el-icon-s-claim"></i> {{ $t("m.signInfo") }}
            </span>
          </div>
          <!-- 第一行:时间 -->
          <el-row :gutter="20">
            <el-col :md="24" :sm="24" :push="7" :span="24">
              <h2 class="flicker">{{ currentTime }}</h2>
            </el-col>
          </el-row>
          <!-- 第二行签到信息 -->
          <el-row
            ...
            justify="center"
          >
            <el-col :md="8" :sm="24" :span="8" :push="2">
              <span class="sign-good-title">宜:</span>
              <span class="sign-good-info">{{ signInfo.good }}</span>
            </el-col>
            <el-col :md="8" :sm="24" :span="8" :push="2">
              <!-- <span >运势:</span> -->
              <span class="sign-title">{{ signInfo.sign }}</span>
            </el-col>
            <el-col :md="8" :sm="24" :span="8" :push="2">
              <span class="sign-bad-title">忌:</span>
              <span class="sign-bad-info">{{ signInfo.bad }}</span>
            </el-col>
          </el-row>
          <!-- 第三行 签到按钮 -->
          <el-row :gutter="20" v-if="!signInfoShow">
            <el-col :md="24" :sm="24" :push="8" :span="24">
              <el-button
                :type="'primary'"
                round
                @click="userSign()"
  ...
  methods: {
    ...
    checkSignInfo() {
      api.checkSignInfo().then(
        ...
        (err) => {
          this.signInfoShow = fasle;
        }
      );
    },
    // 今日签到
    userSign() {
      api.getSignInfo().then(
        (res) => {
          console.log(res);
          this.signInfo = res.data.data;
          this.signInfoShow = true;
